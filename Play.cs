...
{ 
   public class Test
   {
      ...
      {
         int[] humanMove = {0, 12, 6, 5, 13, 3, 2, 8};
         Play round1 = new Play(humanMove);
         humanMove = {1, 0, 3, };
         Play round2 = new Play(humanMove);
         humanMove = {5, 7, 6, 8}};
         Play round3 = new Play(humanMove);
         humanMove = {};
         Play round4 = new Play(humanMove);
         humanMove = {};
         Play round5 = new Play(humanMove);
         humanMove = {};
         Play round6 = new Play(humanMove);
         humanMove = {};
